    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-emerald-900 text-white">
        ...
        <section className="bg-white/5 border-y border-white/10 py-12 px-6 text-center">
          ...
          <p className="text-4xl font-bold text-emerald-400 mb-6">8,754<span className="text-slate-400 text-xl font-normal">か所以上</span></p>
          <div className="inline-grid grid-cols-4 sm:grid-cols-7 gap-3 sm:gap-5">
            {[
