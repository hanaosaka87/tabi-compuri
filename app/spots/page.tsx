...
const CATEGORIES = [
  ...
  },
  {
    ...
    label: 'テーマパーク',
    icon: '🎢',
    description: 'ディズニー・USJ・ハウステンボスなど階層別に制覇',
  ...
  },
  {
    ...
    label: '遊園地',
    icon: '🎡',
    description: 'テーマパーク統合版・USJ〜地方遊園地まで階層別に制覇',
  ...
  },
  {
    ...
    label: '水族館',
    icon: '🐠',
    description: '三大水族館（美ら海・海遊館・葛西）から地域まで制覇',
  ...
  },
  {
    ...
    label: '動物園',
    icon: '🦁',
    description: '旭山・上野・天王寺など日本を代表する動物園から制覇',
